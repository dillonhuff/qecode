...
bool formula(const double a, const double b, const double c, const double d, const double h, const double k, const double l, const double x ) {
	...
	double p_6 = ( ( ( ( ( ( ( ( ( ( ( pow( a, 2.0 ) * pow( c, 2.0 ) ) - ( ( ( 2.0 * a ) * pow( c, 2.0 ) ) * x ) ) + ( pow( b, 2.0 ) * pow( c, 2.0 ) ) ) - ( ( ( 2.0 * b ) * pow( c, 2.0 ) ) * k ) ) + ( pow( c, 2.0 ) * pow( d, 2.0 ) ) ) + ( pow( c, 2.0 ) * pow( k, 2.0 ) ) ) - ( pow( c, 2.0 ) * pow( l, 2.0 ) ) ) + ( pow( c, 2.0 ) * pow( x, 2.0 ) ) ) - ( pow( d, 2.0 ) * pow( h, 2.0 ) ) ) + ( ( ( 2.0 * pow( d, 2.0 ) ) * h ) * x ) ) - ( pow( d, 2.0 ) * pow( x, 2.0 ) ) );
	double p_7 = ( ( ( pow( a, 2.0 ) - ( ( 2.0 * a ) * x ) ) - pow( l, 2.0 ) ) + pow( x, 2.0 ) );
	double p_8 = ( ( ( ( ( ( ( ( ( ( ( pow( a, 2.0 ) * pow( c, 2.0 ) ) - ( ( ( 2.0 * a ) * pow( c, 2.0 ) ) * x ) ) - ( pow( b, 2.0 ) * pow( c, 2.0 ) ) ) + ( ( ( 2.0 * b ) * pow( c, 2.0 ) ) * k ) ) + ( pow( c, 2.0 ) * pow( d, 2.0 ) ) ) - ( pow( c, 2.0 ) * pow( k, 2.0 ) ) ) - ( pow( c, 2.0 ) * pow( l, 2.0 ) ) ) + ( pow( c, 2.0 ) * pow( x, 2.0 ) ) ) - ( pow( d, 2.0 ) * pow( h, 2.0 ) ) ) + ( ( ( 2.0 * pow( d, 2.0 ) ) * h ) * x ) ) - ( pow( d, 2.0 ) * pow( x, 2.0 ) ) );


	return ( ( ( !within_eps( p_1, 0.0 , EPSILON ) && ( within_eps( p_2, 0.0 , EPSILON ) || ( p_3 >= 0.0 ) ) ) && ( ( ( ( p_4 <= 0.0 ) && ( p_5 <= 0.0 ) ) || ( ( p_4 >= 0.0 ) && ( p_5 <= 0.0 ) ) ) || ( ( p_6 <= 0.0 ) && ( p_5 >= 0.0 ) ) ) ) || ( ( p_7 <= 0.0 ) && ( ( ( ( p_8 >= 0.0 ) || ( p_5 <= 0.0 ) ) && ( ( !within_eps( p_1, 0.0 , EPSILON ) && ( p_4 < 0.0 ) ) || ( ( p_8 >= 0.0 ) && ( p_5 >= 0.0 ) ) ) ) || ( ( ( p_8 >= 0.0 ) || ( p_5 <= 0.0 ) ) && ( ( !within_eps( p_1, 0.0 , EPSILON ) && ( p_4 > 0.0 ) ) || ( ( p_8 >= 0.0 ) && ( p_5 >= 0.0 ) ) ) ) ) ) );
}
